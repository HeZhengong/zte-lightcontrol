...
public class MenuController extends BaseController {
    ...
    @ResponseBody
    @RequestMapping(value = "/listByLight")
    public Object listByLight(@RequestParam(required = false) Long menuId){
        List<Menu> menus = this.menuService.selectMenusLight(menuId);
        return menus;
    }
