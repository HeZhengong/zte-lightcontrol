...
(function () {
    ...
    c.prototype.getOffset = function () {
        ...
        _getCloseIcon: function () {
            var d = "<img src='" + this._opts.closeIconUrl + "' style='width: 30px;height: 30px;margin-top: 21px;margin-right: -53px' align='right' style='position:absolute;right:0px;cursor:pointer;margin:" + this._opts.closeIconMargin + "'/>";
            return d
            ...
            if (this._marker) {
                this._div.style.left = d.x + this._opts.offset.width - e.anchor.width + this._marker.getOffset().width + e.infoWindowAnchor.width - this._boxWidth / 2 + "px"
            } else {
                this._div.style.left = d.x + this._opts.offset.width - this._boxWidth / 2 + "px"
            }
